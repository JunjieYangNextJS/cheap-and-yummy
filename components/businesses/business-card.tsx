...
export default function BusinessCard({ business }: { business: Business }) {
  ...
  return (
    <a target="_blank" href={url} rel="noopener noreferrer">
      <div
        className=" w-[500px] mb-10 pl-4 pb-5 pt-3 hover:rounded-lg hover:bg-card hover:text-card-foreground hover:shadow-xl"
        // rounded-lg border bg-card text-card-foreground shadow-sm
      >
        <div className="text-black text-[24px] font-semibold pb-1">{name}</div>
